import { Settings, Crown, MapPin, Star, Heart, Bell, LogOut, Plus, TrendingUp } from 'lucide-react';
...
export function ProfilePage({ onShowSubscription, onAddLocation }: ProfilePageProps) {
  ...
  return (
    <div className="h-full overflow-y-auto bg-gradient-to-br from-slate-50 to-gray-100 pb-24">
        ...
        >
          <div className="flex items-center gap-4 mb-6">
            <div className="relative">
              ...
              <div className="absolute -bottom-1 -right-1 w-7 h-7 rounded-xl bg-green-500 border-4 border-blue-600 shadow-lg"></div>
            </div>
            <div className="flex-1">
              <h1 className="text-2xl text-white mb-1">{user.name}</h1>
              <p className="text-blue-100 text-sm">{user.email}</p>
              <p className="text-blue-200 text-xs mt-1">Member since {user.joinDate}</p>
            </div>
          </div>
      ...
      <div className="px-5 py-4 grid grid-cols-2 gap-3">
        ...
        >
          <div className="w-12 h-12 bg-gradient-to-br from-blue-600 to-cyan-600 rounded-2xl flex items-center justify-center mb-3 shadow-lg shadow-blue-600/20">
        ...
        <div className="bg-white rounded-3xl shadow-md overflow-hidden border border-slate-200">
          <button className="w-full flex items-center justify-between p-5 hover:bg-slate-50 transition-colors border-b border-slate-100">
            ...
            <label className="relative inline-block w-12 h-6">
              ...
              />
              <div className="w-12 h-6 bg-slate-200 peer-checked:bg-blue-600 rounded-full transition-all duration-300"></div>
          ...
          <button className="w-full flex items-center justify-between p-5 hover:bg-slate-50 transition-colors border-b border-slate-100">
            <div className="flex items-center gap-3">
              ...
              <span className="text-slate-900 font-medium">App Settings</span>
            </div>
